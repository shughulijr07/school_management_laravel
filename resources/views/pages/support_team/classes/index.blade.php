        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                ...
                <li class="nav-item"><a href="#new-class" class="nav-link" data-toggle="tab"><i class="icon-plus2"></i>
                        Create New Class</a></li>
                <li class="nav-item"><a href="#new-level" class="nav-link" data-toggle="tab"><i class="icon-plus2"></i>
                        Create New Level</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form class="ajax-store" method="post" action="{{ route('classes.store') }}">
                                ...
                                <div class="form-group row">
                                    <label for="class_type_id" class="col-lg-3 col-form-label font-weight-semibold">Class
                                        Type</label>
                                    <div class="col-lg-9">
                        ...
                        <div class="col-md-6">
                            <form method="post" action="/add-level">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input name="name" value="{{ old('name') }}" required type="text"
                                            class="form-control" placeholder="Level name">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="class_type_id" class="col-lg-3 col-form-label font-weight-semibold">Level
                                        Code</label>
                                    <div class="col-lg-9">
                                        <input name="code" value="{{ old('code') }}" required type="text"
                                            class="form-control" placeholder="Level Code">
                                    </div>
                                </div>
                                        ...
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-left">
                                                    @if (Qs::userIsTeamSA())
                                                        {{-- Edit --}}
                                                        <a href="{{ route('classes.edit', $level->id) }}"
                                                            class="dropdown-item"><i class="icon-pencil"></i> Edit</a>
                                                    @endif
                                                    @if (Qs::userIsSuperAdmin())
                                                        {{-- Delete --}}
                                                        <a id="{{ $level->id }}" onclick="confirmDelete(this.id)"
                                                            class="dropdown-item">
                                                            <i class="icon-trash"></i> Delete</a>
                                                        <form method="post" id="item-delete-{{ $level->id }}"
                                                            action="{{ route('delete-level', $level->id) }}"
